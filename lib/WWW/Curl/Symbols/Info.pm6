...
sub perl6_curlinfo_double returns int is native('libperl6_curl') { * }
sub CURLINFO_DOUBLE is export { perl6_curlinfo_double }
...
sub perl6_curlinfo_http_code returns int is native('libperl6_curl') { * }
sub CURLINFO_HTTP_CODE is export { perl6_curlinfo_http_code }
...
sub perl6_curlinfo_long returns int is native('libperl6_curl') { * }
sub CURLINFO_LONG is export { perl6_curlinfo_long }
sub perl6_curlinfo_mask returns int is native('libperl6_curl') { * }
sub CURLINFO_MASK is export { perl6_curlinfo_mask }
...
sub perl6_curlinfo_slist returns int is native('libperl6_curl') { * }
sub CURLINFO_SLIST is export { perl6_curlinfo_slist }
...
sub perl6_curlinfo_string returns int is native('libperl6_curl') { * }
sub CURLINFO_STRING is export { perl6_curlinfo_string }
...
sub perl6_curlinfo_typemask returns int is native('libperl6_curl') { * }
sub CURLINFO_TYPEMASK is export { perl6_curlinfo_typemask }
